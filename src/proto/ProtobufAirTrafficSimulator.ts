...
export interface CurrentAirspaceConfigurationMessage {
	/**
	 * @generated from protobuf field: string CurrentAirspaceConfiguration = 1
	 */
...
/**
 * @generated from protobuf message ProtobufAirTrafficSimulator.FlightConflictUpdateMessage
 */
export interface FlightConflictUpdateMessage {
	/**
	...
	callSign: string;
	/**
	 * @generated from protobuf field: string conflictingFlightId = 3
	 */
	conflictingFlightId: string;
	/**
	 * @generated from protobuf field: string conflictingFlightCallSign = 4
	 */
	conflictingFlightCallSign: string;
	/**
	 * @generated from protobuf field: ProtobufAirTrafficSimulator.ConflictType conflictType = 5
	 */
	conflictType: ConflictType;
	/**
	 * @generated from protobuf field: ProtobufAirTrafficSimulator.ConflictUpdate conflictUpdate = 6
	 */
	conflictUpdate: ConflictUpdate;
	/**
	 * @generated from protobuf field: ProtobufAirTrafficSimulator.Position4D flightPosition = 7
	 */
	flightPosition?: Position4D;
	/**
	 * @generated from protobuf field: ProtobufAirTrafficSimulator.Position4D conflictingFlightPosition = 8
	 */
	conflictingFlightPosition?: Position4D;
}
// Changing the file
 ...
 *
 * @generated from protobuf enum ProtobufAirTrafficSimulator.ConflictType
 */
export enum ConflictType {
	/**
	 * Short term conflict alert, based on current radar speed, direction.
	 *
	 * @generated from protobuf enum value: STCA = 0;
	 */
	STCA = 0,
	/**
	 * Tactical conflict tool, based on trajectory prediction.
	 *
	 * @generated from protobuf enum value: TCT = 1;
	 */
	TCT = 1,
	/**
	 * Medium term conflict detection, based on flight plans.
	 *
	 * @generated from protobuf enum value: MTCD = 2;
	 */
	MTCD = 2,
}
/**
 * The type of update
 *
 * @generated from protobuf enum ProtobufAirTrafficSimulator.ConflictUpdate
 */
export enum ConflictUpdate {
	/**
	 * A new alert which is just automatically detected.
	 *
	 * @generated from protobuf enum value: New = 0;
	 */
	New = 0,
	/**
	 * An existing alert is automatically cleared.
	 *
	 * @generated from protobuf enum value: Cleared = 1;
	 */
	Cleared = 1,
}
...
class PreferenceInterval$Type extends MessageType<PreferenceInterval> {
	constructor() {
		super("ProtobufAirTrafficSimulator.PreferenceInterval", [
			...
			{
				no: 3,
				name: "costPerSecondEarlier",
				kind: "scalar",
				T: 2 /*ScalarType.FLOAT*/,
			},
			{
				no: 4,
				name: "costPerSecondLater",
				kind: "scalar",
				T: 2 /*ScalarType.FLOAT*/,
			},
		]);
	...
	create(value?: PartialMessage<PreferenceInterval>): PreferenceInterval {
		...
		message.costPerSecondEarlier = 0;
		message.costPerSecondLater = 0;
		if (value !== undefined)
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* google.protobuf.Duration maxEarlier */ 1:
					message.maxEarlier = Duration.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.maxEarlier,
				...
				case /* google.protobuf.Duration maxLater */ 2:
					message.maxLater = Duration.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.maxLater,
...
class AvailabilitySchedule$Type extends MessageType<AvailabilitySchedule> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated ProtobufAirTrafficSimulator.AvailabilityIntervalsMessage availabilityIntervals */ 1:
					message.availabilityIntervals.push(
						AvailabilityIntervalsMessage.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
						),
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.availabilityIntervals.length; i++)
			AvailabilityIntervalsMessage.internalBinaryWrite(
				message.availabilityIntervals[i],
				writer.tag(1, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
	...
	constructor() {
		super("ProtobufAirTrafficSimulator.Position4DCartesian", [
			...
			{ no: 4, name: "z", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
			{
				...
				name: "milestone",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.Milestone", Milestone],
			},
		]);
	}
	...
	constructor() {
		super("ProtobufAirTrafficSimulator.PositionAtObject", [
			...
			{ no: 2, name: "objectId", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{
				...
				name: "objectType",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.ObjectType", ObjectType],
			},
			{
				no: 4,
				name: "milestone",
...
class Position$Type extends MessageType<Position> {
	constructor() {
		super("ProtobufAirTrafficSimulator.Position", [
			...
			{
				no: 2,
				name: "position4DCartesian",
				kind: "message",
				oneof: "position",
				T: () => Position4DCartesian,
			},
			{
				no: 3,
				name: "positionAtObject",
				kind: "message",
				oneof: "position",
				T: () => PositionAtObject,
			},
	...
	create(value?: PartialMessage<Position>): Position {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.position = { oneofKind: undefined };
		if (value !== undefined)
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* ProtobufAirTrafficSimulator.Position4D position4D */ 1:
					message.position = {
						oneofKind: "position4D",
						position4D: Position4D.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.position as any).position4D,
						),
					};
					break;
				case /* ProtobufAirTrafficSimulator.Position4DCartesian position4DCartesian */ 2:
					message.position = {
						oneofKind: "position4DCartesian",
						position4DCartesian: Position4DCartesian.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.position as any).position4DCartesian,
						),
					};
					break;
				case /* ProtobufAirTrafficSimulator.PositionAtObject positionAtObject */ 3:
					message.position = {
						oneofKind: "positionAtObject",
						positionAtObject: PositionAtObject.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.position as any).positionAtObject,
						),
					};
					break;
				default:
...
class AirspaceVolumeReference$Type extends MessageType<AirspaceVolumeReference> {
	...
	create(
		value?: PartialMessage<AirspaceVolumeReference>,
	): AirspaceVolumeReference {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.volumeId = "";
		message.bottomFlightLevel = 0;
		message.topFlightLevel = 0;
		if (value !== undefined)
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AirspaceVolumeReference,
	): AirspaceVolumeReference {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
class TesselatedSectorSurface$Type extends MessageType<TesselatedSectorSurface> {
	...
	create(
		value?: PartialMessage<TesselatedSectorSurface>,
	): TesselatedSectorSurface {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.corners = [];
		message.triangles = [];
		if (value !== undefined)
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: TesselatedSectorSurface,
	): TesselatedSectorSurface {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated ProtobufAirTrafficSimulator.Position corners */ 1:
					message.corners.push(
						Position.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
...
class InitialisationCompleted$Type extends MessageType<InitialisationCompleted> {
	...
	create(
		value?: PartialMessage<InitialisationCompleted>,
	): InitialisationCompleted {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.numAirspaceConfigs = 0;
		message.numAirspaces = 0;
		message.numSectors = 0;
		message.numAirblocks = 0;
		message.numWaypoints = 0;
		if (value !== undefined)
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: InitialisationCompleted,
	): InitialisationCompleted {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
class AllTargetReports$Type extends MessageType<AllTargetReports> {
			...
			switch (fieldNo) {
				case /* repeated ProtobufAirTrafficSimulator.TargetReportMessage reports */ 1:
					message.reports.push(
						TargetReportMessage.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
						),
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.reports.length; i++)
			TargetReportMessage.internalBinaryWrite(
				message.reports[i],
				writer.tag(1, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class FlightMilestoneTimeMessage$Type extends MessageType<FlightMilestoneTimeMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.FlightMilestoneTimeMessage", [
			...
			},
			{
				...
				name: "planningStage",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.PlanningStage", PlanningStage],
			},
			{
				no: 4,
				name: "milestone",
			...
			{
				no: 6,
				name: "preferenceInterval",
				kind: "message",
				T: () => PreferenceInterval,
			},
		]);
	}
	create(
		value?: PartialMessage<FlightMilestoneTimeMessage>,
	): FlightMilestoneTimeMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.xmlElementName = "";
		message.flightUniqueId = "";
		message.planningStage = 0;
		message.milestone = 0;
		if (value !== undefined)
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: FlightMilestoneTimeMessage,
	): FlightMilestoneTimeMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* google.protobuf.Timestamp milestoneTime */ 5:
					message.milestoneTime = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.milestoneTime,
					);
					break;
				case /* ProtobufAirTrafficSimulator.PreferenceInterval preferenceInterval */ 6:
					message.preferenceInterval = PreferenceInterval.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.preferenceInterval,
	...
	internalBinaryWrite(
		...
		if (message.preferenceInterval)
			PreferenceInterval.internalBinaryWrite(
				message.preferenceInterval,
...
class FlightMilestonePositionMessage$Type extends MessageType<FlightMilestonePositionMessage> {
	...
	create(
		value?: PartialMessage<FlightMilestonePositionMessage>,
		...
		if (value !== undefined)
			reflectionMergePartial<FlightMilestonePositionMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: FlightMilestonePositionMessage,
	): FlightMilestonePositionMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* ProtobufAirTrafficSimulator.PositionAtObject position */ 5:
					message.position = PositionAtObject.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.position,
				...
				case /* google.protobuf.Timestamp timeStampSent */ 7:
					message.timeStampSent = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
 ...
 */
export const FlightMilestonePositionMessage =
	new FlightMilestonePositionMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PlannedFlightMessage$Type extends MessageType<PlannedFlightMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.PlannedFlightMessage", [
			...
			{
				no: 4,
				name: "minimumRunwaySeparation",
				kind: "message",
				T: () => Duration,
			},
			{
				no: 5,
				name: "minimumFlowSeparation",
				kind: "message",
				T: () => Duration,
			},
		]);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: PlannedFlightMessage,
	): PlannedFlightMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				...
				case /* ProtobufAirTrafficSimulator.Trajectory trajectory */ 3:
					message.trajectory = Trajectory.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.trajectory,
				...
				case /* google.protobuf.Duration minimumRunwaySeparation */ 4:
					message.minimumRunwaySeparation = Duration.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.minimumRunwaySeparation,
					);
					break;
				case /* google.protobuf.Duration minimumFlowSeparation */ 5:
					message.minimumFlowSeparation = Duration.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.minimumFlowSeparation,
					);
					break;
				default:
					let u = options.readUnknownField;
	...
	internalBinaryWrite(
		...
		if (message.trajectory)
			Trajectory.internalBinaryWrite(
				message.trajectory,
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class NewAircraftMessage$Type extends MessageType<NewAircraftMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.NewAircraftMessage", [
			...
			},
			{
				...
				kind: "enum",
				T: () => [
					"ProtobufAirTrafficSimulator.WakeTurbulenceCategory",
	...
	create(value?: PartialMessage<NewAircraftMessage>): NewAircraftMessage {
		...
		message.wakeTurbulenceCategory = 0;
		if (value !== undefined)
...
class NewAircraftTypeMessage$Type extends MessageType<NewAircraftTypeMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.NewAircraftTypeMessage", [
			...
			{
				no: 3,
				name: "preferredGroundSpeed",
				kind: "scalar",
				T: 2 /*ScalarType.FLOAT*/,
			},
			{
				no: 4,
				name: "maximumGroundSpeed",
				kind: "scalar",
				T: 2 /*ScalarType.FLOAT*/,
			},
			{
				no: 5,
				name: "minimumTakeOffDistance",
				kind: "scalar",
				T: 2 /*ScalarType.FLOAT*/,
			},
			...
			{
				no: 9,
				name: "takeOffSpeedCategory",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.SpeedCategory", SpeedCategory],
			},
			{ no: 10, name: "minStartUpTime", kind: "message", T: () => Duration },
			{
				...
				name: "aircraftClass",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.AircraftClass", AircraftClass],
			},
			{ no: 12, name: "height", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
			{
				...
				kind: "enum",
				T: () => [
					"ProtobufAirTrafficSimulator.VehicleCategory",
					VehicleCategory,
				],
			},
		]);
	...
	create(
		value?: PartialMessage<NewAircraftTypeMessage>,
	): NewAircraftTypeMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.xmlElementName = "";
		message.vehicleTypeId = "";
		message.preferredGroundSpeed = 0;
		message.maximumGroundSpeed = 0;
		message.minimumTakeOffDistance = 0;
		message.wingSpan = 0;
		message.length = 0;
		message.wakeTurbulenceCategory = 0;
		message.takeOffSpeedCategory = 0;
		message.aircraftClass = 0;
		message.height = 0;
		message.vehicleCategory = 0;
		if (value !== undefined)
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* google.protobuf.Duration minStartUpTime */ 10:
					message.minStartUpTime = Duration.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.minStartUpTime,
					);
					break;
...
class FlightStatusCodeMessage$Type extends MessageType<FlightStatusCodeMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.FlightStatusCodeMessage", [
			...
			},
			{
				...
				kind: "enum",
				T: () => [
					"ProtobufAirTrafficSimulator.FlightStatusCode",
					FlightStatusCode,
				],
			},
		]);
	...
	create(
		value?: PartialMessage<FlightStatusCodeMessage>,
	): FlightStatusCodeMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.xmlElementName = "";
		message.flightUniqueId = "";
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: FlightStatusCodeMessage,
	): FlightStatusCodeMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* ProtobufAirTrafficSimulator.Trajectory route */ 5:
					message.route = Trajectory.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.route,
...
class NewStandManoeuvreMessage$Type extends MessageType<NewStandManoeuvreMessage> {
	...
	create(
		value?: PartialMessage<NewStandManoeuvreMessage>,
	): NewStandManoeuvreMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.xmlElementName = "";
		message.networkId = "";
		message.routeId = "";
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: NewStandManoeuvreMessage,
	): NewStandManoeuvreMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* ProtobufAirTrafficSimulator.Position stand */ 7:
					message.stand = Position.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.stand,
				...
				case /* ProtobufAirTrafficSimulator.Position endPushback */ 8:
					message.endPushback = Position.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.endPushback,
...
class NewAirspaceMessage$Type extends MessageType<NewAirspaceMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.NewAirspaceMessage", [
			...
			{
				no: 3,
				name: "includedAirspaceVolumes",
				kind: "message",
				repeat: 2 /*RepeatType.UNPACKED*/,
				T: () => AirspaceVolumeReference,
			},
			{
				no: 4,
				name: "area",
	...
	create(value?: PartialMessage<NewAirspaceMessage>): NewAirspaceMessage {
		...
		message.xmlElementName = "";
		message.airspaceId = "";
		message.includedAirspaceVolumes = [];
		message.area = [];
		message.description = "";
		message.objectType = 0;
		message.bottomFlightLevel = 0;
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* repeated ProtobufAirTrafficSimulator.AirspaceVolumeReference includedAirspaceVolumes */ 3:
					message.includedAirspaceVolumes.push(
						AirspaceVolumeReference.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
						),
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.includedAirspaceVolumes.length; i++)
			AirspaceVolumeReference.internalBinaryWrite(
				message.includedAirspaceVolumes[i],
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class NewAirspaceConfigurationMessage$Type extends MessageType<NewAirspaceConfigurationMessage> {
	...
	create(
		value?: PartialMessage<NewAirspaceConfigurationMessage>,
		...
		message.objectType = 0;
		if (value !== undefined)
			reflectionMergePartial<NewAirspaceConfigurationMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: NewAirspaceConfigurationMessage,
	): NewAirspaceConfigurationMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
 ...
 */
export const NewAirspaceConfigurationMessage =
	new NewAirspaceConfigurationMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* google.protobuf.Timestamp endttime */ 2:
					message.endttime = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.endttime,
...
class AirspaceAvailabilityMessage$Type extends MessageType<AirspaceAvailabilityMessage> {
	...
	create(
		value?: PartialMessage<AirspaceAvailabilityMessage>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AirspaceAvailabilityMessage,
	): AirspaceAvailabilityMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
 ...
 */
export const AirspaceAvailabilityMessage =
	new AirspaceAvailabilityMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AvailabilityIntervalsMessage$Type extends MessageType<AvailabilityIntervalsMessage> {
	...
	create(
		value?: PartialMessage<AvailabilityIntervalsMessage>,
		...
		if (value !== undefined)
			reflectionMergePartial<AvailabilityIntervalsMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AvailabilityIntervalsMessage,
	): AvailabilityIntervalsMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* repeated ProtobufAirTrafficSimulator.TimeInterval timeIntervals */ 3:
					message.timeIntervals.push(
						TimeInterval.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				default:
					let u = options.readUnknownField;
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.timeIntervals.length; i++)
			TimeInterval.internalBinaryWrite(
				message.timeIntervals[i],
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
 ...
 */
export const AvailabilityIntervalsMessage =
	new AvailabilityIntervalsMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
	...
	constructor() {
		super("ProtobufAirTrafficSimulator.NewSegmentMessage", [
			...
			{ no: 3, name: "segmentId", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: "enum",
				T: () => [
					"ProtobufAirTrafficSimulator.NetworkResourceType",
					NetworkResourceType,
				],
			},
			...
			{ no: 6, name: "curvature", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
			{
				...
				kind: "enum",
				T: () => [
					"ProtobufAirTrafficSimulator.SegmentDirection",
					SegmentDirection,
				],
			},
		]);
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* ProtobufAirTrafficSimulator.Trajectory points */ 5:
					message.points = Trajectory.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.points,
	...
	constructor() {
		super("ProtobufAirTrafficSimulator.NewWaypointMessage", [
			...
			},
			{
				...
				name: "waypointType",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.WaypointType", WaypointType],
			},
			{
				no: 6,
				name: "points",
...
class RoleConfigurationMessage$Type extends MessageType<RoleConfigurationMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.RoleConfigurationMessage", [
			...
			{
				no: 2,
				name: "sectorToControl",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				no: 3,
				name: "actualIdOfSectorToControl",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				no: 4,
				name: "acceptedFlights",
				kind: "scalar",
				repeat: 2 /*RepeatType.UNPACKED*/,
				T: 9 /*ScalarType.STRING*/,
			},
	...
	create(
		value?: PartialMessage<RoleConfigurationMessage>,
	): RoleConfigurationMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.roleName = "";
		message.sectorToControl = "";
		message.actualIdOfSectorToControl = "";
		message.acceptedFlights = [];
		message.tentativeFlights = [];
		if (value !== undefined)
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: RoleConfigurationMessage,
	): RoleConfigurationMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
class CurrentAirspaceConfigurationMessage$Type extends MessageType<CurrentAirspaceConfigurationMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.CurrentAirspaceConfigurationMessage", [
			{
				no: 1,
				name: "CurrentAirspaceConfiguration",
				kind: "scalar",
				jsonName: "CurrentAirspaceConfiguration",
				T: 9 /*ScalarType.STRING*/,
			},
		]);
	}
	create(
		value?: PartialMessage<CurrentAirspaceConfigurationMessage>,
	): CurrentAirspaceConfigurationMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.currentAirspaceConfiguration = "";
		if (value !== undefined)
			reflectionMergePartial<CurrentAirspaceConfigurationMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: CurrentAirspaceConfigurationMessage,
	): CurrentAirspaceConfigurationMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* string CurrentAirspaceConfiguration */ 1:
	...
	internalBinaryWrite(
		...
		if (message.currentAirspaceConfiguration !== "")
			writer
				...
				.string(message.currentAirspaceConfiguration);
		let u = options.writeUnknownFields;
		if (u !== false)
			(u == true ? UnknownFieldHandler.onWrite : u)(
				this.typeName,
 ...
 */
export const CurrentAirspaceConfigurationMessage =
	new CurrentAirspaceConfigurationMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TesselatedAirspaceVolumeMessage$Type extends MessageType<TesselatedAirspaceVolumeMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.TesselatedAirspaceVolumeMessage", [
			{
				no: 1,
				name: "airspaceVolumeId",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				no: 2,
				name: "belongsToAirspaceConfigId",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				no: 3,
				name: "numberOfVolumesInConfig",
				kind: "scalar",
				T: 5 /*ScalarType.INT32*/,
			},
			{
				no: 4,
				name: "tesselatedSurfaces",
				kind: "message",
				repeat: 2 /*RepeatType.UNPACKED*/,
				T: () => TesselatedSectorSurface,
			},
		]);
	}
	create(
		value?: PartialMessage<TesselatedAirspaceVolumeMessage>,
	): TesselatedAirspaceVolumeMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.airspaceVolumeId = "";
		message.belongsToAirspaceConfigId = "";
		message.numberOfVolumesInConfig = 0;
		message.tesselatedSurfaces = [];
		if (value !== undefined)
			reflectionMergePartial<TesselatedAirspaceVolumeMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: TesselatedAirspaceVolumeMessage,
	): TesselatedAirspaceVolumeMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* repeated ProtobufAirTrafficSimulator.TesselatedSectorSurface tesselatedSurfaces */ 4:
					message.tesselatedSurfaces.push(
						TesselatedSectorSurface.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
						),
	...
	internalBinaryWrite(
		...
		if (message.belongsToAirspaceConfigId !== "")
			writer
				...
				.string(message.belongsToAirspaceConfigId);
		...
		for (let i = 0; i < message.tesselatedSurfaces.length; i++)
			TesselatedSectorSurface.internalBinaryWrite(
				message.tesselatedSurfaces[i],
				writer.tag(4, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
 ...
 */
export const TesselatedAirspaceVolumeMessage =
	new TesselatedAirspaceVolumeMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class NewAirspaceVolumeFlightListMessage$Type extends MessageType<NewAirspaceVolumeFlightListMessage> {
	...
	create(
		value?: PartialMessage<NewAirspaceVolumeFlightListMessage>,
	): NewAirspaceVolumeFlightListMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.airspaceVolumeId = "";
		message.flightsInVolume = [];
		if (value !== undefined)
			reflectionMergePartial<NewAirspaceVolumeFlightListMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: NewAirspaceVolumeFlightListMessage,
	): NewAirspaceVolumeFlightListMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.flightsInVolume.length; i++)
			writer
				.tag(2, WireType.LengthDelimited)
				.string(message.flightsInVolume[i]);
		let u = options.writeUnknownFields;
		if (u !== false)
			(u == true ? UnknownFieldHandler.onWrite : u)(
				this.typeName,
 ...
 */
export const NewAirspaceVolumeFlightListMessage =
	new NewAirspaceVolumeFlightListMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AirTrafficControllerAssignmentMessage$Type extends MessageType<AirTrafficControllerAssignmentMessage> {
	...
	create(
		value?: PartialMessage<AirTrafficControllerAssignmentMessage>,
	): AirTrafficControllerAssignmentMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.airTrafficControllerId = "";
		message.sectorIds = [];
		if (value !== undefined)
			reflectionMergePartial<AirTrafficControllerAssignmentMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AirTrafficControllerAssignmentMessage,
	): AirTrafficControllerAssignmentMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
	...
	internalBinaryWrite(
		...
		if (message.airTrafficControllerId !== "")
			writer
				.tag(1, WireType.LengthDelimited)
				.string(message.airTrafficControllerId);
 ...
 */
export const AirTrafficControllerAssignmentMessage =
	new AirTrafficControllerAssignmentMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FlightEnteringAirspaceMessage$Type extends MessageType<FlightEnteringAirspaceMessage> {
	...
	create(
		value?: PartialMessage<FlightEnteringAirspaceMessage>,
	): FlightEnteringAirspaceMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.flightUniqueId = "";
		message.sectorId = "";
		message.entryWaypointId = "";
		message.exitWaypointId = "";
		message.planningStage = 0;
		if (value !== undefined)
			reflectionMergePartial<FlightEnteringAirspaceMessage>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: FlightEnteringAirspaceMessage,
	): FlightEnteringAirspaceMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* ProtobufAirTrafficSimulator.Position4D entryPosition */ 3:
					message.entryPosition = Position4D.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
				...
				case /* ProtobufAirTrafficSimulator.Position4D exitPosition */ 4:
					message.exitPosition = Position4D.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
 ...
 */
export const FlightEnteringAirspaceMessage =
	new FlightEnteringAirspaceMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AddAcceptedFlightMessage$Type extends MessageType<AddAcceptedFlightMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.AddAcceptedFlightMessage", [
			{
				no: 1,
				name: "fromControllableAirspaceVolume",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				no: 2,
				name: "toControllableAirspaceVolume",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
	...
	create(
		value?: PartialMessage<AddAcceptedFlightMessage>,
	): AddAcceptedFlightMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.fromControllableAirspaceVolume = "";
		message.toControllableAirspaceVolume = "";
		message.flightId = "";
		if (value !== undefined)
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AddAcceptedFlightMessage,
	): AddAcceptedFlightMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
	...
	internalBinaryWrite(
		...
		if (message.fromControllableAirspaceVolume !== "")
			writer
				.tag(1, WireType.LengthDelimited)
				.string(message.fromControllableAirspaceVolume);
		/* string toControllableAirspaceVolume = 2; */
		if (message.toControllableAirspaceVolume !== "")
			writer
				.tag(2, WireType.LengthDelimited)
				.string(message.toControllableAirspaceVolume);
		/* string flightId = 3; */
		if (message.flightId !== "")
...
class AddTentativeFlightMessage$Type extends MessageType<AddTentativeFlightMessage> {
	...
	create(
		value?: PartialMessage<AddTentativeFlightMessage>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AddTentativeFlightMessage,
	): AddTentativeFlightMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
// @generated message type with reflection information, may provide speed optimized methods
class FlightConflictUpdateMessage$Type extends MessageType<FlightConflictUpdateMessage> {
	constructor() {
		super("ProtobufAirTrafficSimulator.FlightConflictUpdateMessage", [
			{ no: 1, name: "flightId", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{ no: 2, name: "callSign", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{
				no: 3,
				name: "conflictingFlightId",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				no: 4,
				name: "conflictingFlightCallSign",
				kind: "scalar",
				T: 9 /*ScalarType.STRING*/,
			},
			{
				...
				name: "conflictType",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.ConflictType", ConflictType],
			},
			{
				no: 6,
				name: "conflictUpdate",
				kind: "enum",
				T: () => ["ProtobufAirTrafficSimulator.ConflictUpdate", ConflictUpdate],
			},
			{ no: 7, name: "flightPosition", kind: "message", T: () => Position4D },
			{
				no: 8,
				name: "conflictingFlightPosition",
				kind: "message",
				T: () => Position4D,
			},
		]);
	...
	create(
		value?: PartialMessage<FlightConflictUpdateMessage>,
	): FlightConflictUpdateMessage {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.flightId = "";
		message.callSign = "";
		message.conflictingFlightId = "";
		message.conflictingFlightCallSign = "";
		message.conflictType = 0;
		message.conflictUpdate = 0;
		if (value !== undefined)
			reflectionMergePartial<FlightConflictUpdateMessage>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		length: number,
		options: BinaryReadOptions,
		target?: FlightConflictUpdateMessage,
	): FlightConflictUpdateMessage {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* string callSign */ 2:
					message.callSign = reader.string();
					break;
				case /* string conflictingFlightId */ 3:
					message.conflictingFlightId = reader.string();
					break;
				case /* string conflictingFlightCallSign */ 4:
					message.conflictingFlightCallSign = reader.string();
					break;
				case /* ProtobufAirTrafficSimulator.ConflictType conflictType */ 5:
					message.conflictType = reader.int32();
					break;
				case /* ProtobufAirTrafficSimulator.ConflictUpdate conflictUpdate */ 6:
					message.conflictUpdate = reader.int32();
					break;
				case /* ProtobufAirTrafficSimulator.Position4D flightPosition */ 7:
					message.flightPosition = Position4D.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.flightPosition,
					);
					break;
				case /* ProtobufAirTrafficSimulator.Position4D conflictingFlightPosition */ 8:
					message.conflictingFlightPosition = Position4D.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.conflictingFlightPosition,
					);
					break;
				default:
					let u = options.readUnknownField;
	...
	internalBinaryWrite(
		...
		if (message.conflictingFlightId !== "")
			writer
				.tag(3, WireType.LengthDelimited)
				.string(message.conflictingFlightId);
		/* string conflictingFlightCallSign = 4; */
		if (message.conflictingFlightCallSign !== "")
			writer
				.tag(4, WireType.LengthDelimited)
				.string(message.conflictingFlightCallSign);
		/* ProtobufAirTrafficSimulator.ConflictType conflictType = 5; */
		if (message.conflictType !== 0)
			writer.tag(5, WireType.Varint).int32(message.conflictType);
		/* ProtobufAirTrafficSimulator.ConflictUpdate conflictUpdate = 6; */
		if (message.conflictUpdate !== 0)
			writer.tag(6, WireType.Varint).int32(message.conflictUpdate);
		/* ProtobufAirTrafficSimulator.Position4D flightPosition = 7; */
		if (message.flightPosition)
			Position4D.internalBinaryWrite(
				message.flightPosition,
				writer.tag(7, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* ProtobufAirTrafficSimulator.Position4D conflictingFlightPosition = 8; */
		if (message.conflictingFlightPosition)
			Position4D.internalBinaryWrite(
				message.conflictingFlightPosition,
				writer.tag(8, WireType.LengthDelimited).fork(),
				options,
 ...
 */
export const FlightConflictUpdateMessage =
	new FlightConflictUpdateMessage$Type();
