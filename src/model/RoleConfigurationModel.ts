...
const flightColors = ['#f59', '#0bb', '#94a', '#b00', '#f80', '#f63', '#3c0', '#40f', '#DDD555', '#01539d', '#e9b4d0', '#8c9441', '#c82169'];
export default class RoleConfigurationModel {
  ...
  inSectorToControl(sector: string): boolean {
    if (this.sectorsToControl.includes(sector)) {
      return true;
    }
    return false;
  }
