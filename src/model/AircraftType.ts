...
import type {
  AircraftClass, NewAircraftTypeMessage, VehicleCategory, WakeTurbulenceCategory,
...
export default class AircraftType {
  ...
  static fromProto(newAircraftTypeMessage: NewAircraftTypeMessage): AircraftType {
