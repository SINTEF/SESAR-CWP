...
function buildSpeedVectorLocations(aircraft: AircraftModel, minutesInTheFuture: number)
  : [number, number][] {
...
function buildGeoJsonSpeedVector(aircraft: AircraftModel, minutesInTheFuture: number)
  : GeoJSON.Feature[] {
